...
//	 @Autowired private JwtUtil jwtUtil;
	...
	@Operation(summary = "Api to get all user roles") public ResponseEntity<?>
	getAllUsers() {
	...
	@Operation(summary = "Api to register any User") public ResponseEntity<?>
	...
	@Operation(summary = "Api to login any User") public ResponseEntity<?>
